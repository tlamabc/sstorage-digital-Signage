...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!./node_modules/sass-loader/dist/cjs.js!./ui/src/pages/display/display-page.scss":
/*!***************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!./node_modules/sass-loader/dist/cjs.js!./ui/src/pages/display/display-page.scss ***!
  \***************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#settings-from-profile tr.row-fluid {\n  height: 50px;\n}", "",{"version":3,"sources":["webpack://./ui/src/pages/display/display-page.scss"],"names":[],"mappings":"AAAA;EACE,YAAA;AACF","sourceRoot":""}]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_3_use_2_node_modules_sass_loader_dist_cjs_js_display_page_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js!../../../../node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!../../../../node_modules/sass-loader/dist/cjs.js!./display-page.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!./node_modules/sass-loader/dist/cjs.js!./ui/src/pages/display/display-page.scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_3_use_2_node_modules_sass_loader_dist_cjs_js_display_page_scss__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ __webpack_exports__["default"] = (_node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_3_use_2_node_modules_sass_loader_dist_cjs_js_display_page_scss__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_3_use_2_node_modules_sass_loader_dist_cjs_js_display_page_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_3_use_2_node_modules_sass_loader_dist_cjs_js_display_page_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/*!**********************************************!*\
  ...
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _display_page_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./display-page.scss */ "./ui/src/pages/display/display-page.scss");
...
$(function () {
  ...
  const table = $('#displays').DataTable({
    ...
    ...(taggingEnabled ? [{
      ...
      render: function (data, type) {
        if (type !== 'display') {
          return data < playerVersionSupport ? displayPageTrans.no : displayPageTrans.yes;
        }
      ...
      render: function (data, type) {
        ...
        if (typeof data !== undefined && data != null) {
          ...
          for (let i = 0; i < arrayOfTags.length; i++) {
            ...
            if (name !== '') {
              returnData += '<li class="badge">' + name + '</span></li>';
            }
          }
          returnData += '</div>';
        }
      ...
      render: function (data, type, row) {
        if (type === 'display') {
          ...
          if (SHOW_DISPLAY_AS_VNCLINK !== '' && row.clientAddress != null && row.clientAddress !== '') {
            const link = SHOW_DISPLAY_AS_VNCLINK.replace('%s', row.clientAddress);
            html += '<a href="' + link + '" title="' + displayPageTrans.VNCtoThisDisplay + '" target="' + SHOW_DISPLAY_AS_VNC_TGT + '">' + '<i class="fa fa-eye"></i></a>';
          }
          if (row.teamViewerLink !== '') {
            html += '<a href="' + row.teamViewerLink + '" title="' + displayPageTrans.TeamViewertoThisDisplay + '" target="_blank">' + '<img src="' + publicPath + 'theme/default/img/remote_icons/teamviewer.png"' + ' alt="TeamViewer Icon"></a>';
          }
          if (row.webkeyLink !== '') {
            html += '<a href="' + row.webkeyLink + '" title="' + displayPageTrans.WebkeytoThisDisplay + '" target="_blank">' + '<img src="' + publicPath + 'theme/default/img/remote_icons/webkey.png" ' + 'alt="Webkey Icon"></a>';
          }
          return html + '</div>';
        } else if (type === 'export') {
          if (row.teamViewerLink !== '') {
  ...
  table.on('draw', function (e, settings) {
    dataTableDraw(e, settings, function () {
      ...
      const $mapController = target.closest('.XiboGrid').find('.map-controller');
      const $listController = target.closest('.XiboGrid').find('.list-controller');
  ...
  function initializeMap() {
    ...
    markerClusterGroup = L.markerClusterGroup({
      ...
      iconCreateFunction: function (cluster) {
        ...
        const pieHtml = createPieChart([upToDate, outOfDate, downloading], ['rgba(181, 226, 140, 0.9)', 'rgba(243, 194, 18, 0.9)', 'rgba(219, 70, 79, 0.9)']);
  ...
  function addMarkersToMap(bounds) {
          ...
          const feature = L.geoJSON(response, {
            pointToLayer: function (feature, latlng) {
              ...
              if (feature.properties.lastAccessed) {
                const lastAccessed = moment(feature.properties.lastAccessed, 'X').tz ? moment(feature.properties.lastAccessed, 'X').tz(timezone).format(jsDateFormat) : moment(feature.properties.lastAccessed, 'X').format(jsDateFormat);
              ...
              if (!displayIdCache.includes(feature.properties.displayId)) {
                ...
                // Add a marker
                return marker.bindPopup(popup).openPopup().addTo(markerClusterGroup);
              }
            }
          });
        }
    ...
    markerClusterGroup.on('clustermouseover', function (event) {
      ...
      // eslint-disable-next-line no-unused-vars
      const popup = L.popup().setLatLng(event.latlng).setContent(popContent).openOn(map);
...
window.setDefaultMultiSelectFormOpen = function (dialog) {
  ...
  const $select = $('<select name="layoutId" class="form-control" data-search-url="' + layoutSearchURL + '" data-search-term="layout" ' + 'data-search-term-tags="tags" data-id-property="layoutId" ' + 'data-text-property="layout">');
  $select.on('change', function (ev) {
    console.debug('Setting commit data to ' + $(ev.currentTarget).val());
    dialog.data().commitData = {
      layoutId: $(ev.currentTarget).val()
    };
  });
...
window.setMoveCmsMultiSelectFormOpen = function (dialog) {
  ...
  const $message = $('<div class="col-sm-12 alert alert-info">' + '<p>' + displayPageTrans.setMoveCmsMultiSelectFormOpen.message + '</p>' + '</div>');
  $(dialog).find('.modal-body').append($message);
  const $cmsAddress = $('<div class="form-group row">' + '<label class="col-sm-2 control-label" for="newCmsAddress" ' + 'accesskey="">New CMS Address</label>' + '<div class="col-sm-10">' + '<input class="form-control" name="newCmsAddress" type="text" ' + 'id="newCmsAddress" value="">' + '<span class="help-block">' + displayPageTrans.newCmsAddressHelp + '</span>' + '</div>' + '</div>');
  const $cmsKey = $('<div class="form-group row">' + '<label class="col-sm-2 control-label" for="newCmsKey" ' + 'accesskey="">New CMS Key</label>' + '<div class="col-sm-10">' + '<input class="form-control" name="newCmsKey" type="text" ' + 'id="newCmsKey" value="">' + '<span class="help-block">' + displayPageTrans.newCmsKeyHelp + '</span>' + '</div>' + '</div>');
  const $authenticationCode = $('<div class="form-group row">' + '<label class="col-sm-2 control-label" for="twoFactorCode" ' + 'accesskey="">Two Factor Code</label>' + '<div class="col-sm-10">' + '<input class="form-control" name="twoFactorCode" type="text" ' + 'id="twoFactorCode" value="">' + '<span class="help-block">' + displayPageTrans.twoFactorCodeHelp + '</span>' + '</div>' + '</div>');
...
window.displayEditFormOpen = function (dialog) {
  ...
  const $settings = $(dialog).find('#settings-from-display-profile').find('.form-group');
  ...
  const createInputField = function (target, inputName) {
    let newValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    ...
    if (timepickerOptionsFixFlag) {
      ...
      $inputParent.append('<div class="text-muted">' + displayPageTrans.adjustTimesofTimer + '</div>');
    }
    if (sliderFixFlag) {
    ...
    if ($(target).find('.multiSelectInputs').length > 0) {
      ...
      const colSize = Math.round(12 / $(target).find('.multiSelectInputs').length);
    ...
    $(target).find('.pictureControlsSlider').bootstrapSlider('refresh', {
      useCurrentValue: true
    });

    // Add help text if exists on label
    const inputHelpText = $(target).parent('tr').find('td:first strong').attr('title');
    if (inputHelpText) {
      $(target).append('<div class="text-muted">' + inputHelpText + '</div>');
    }
    const $newButton = $('<button type="button" ' + 'class="btn btn-outline-danger btn-sm ' + 'pull-right button-close-override">' + '<i class="fa fa-times"></i></button>').on('click', function (e) {
      e.stopPropagation();
  ...
  $.each($settings, function (index, element) {
    ...
    if (overrideEl != undefined) {
      // If element was found, create an input
  ...
  // Handlers for field edit
  $(dialog).find('.override-input[data-editing="false"]').on('click', function (ev) {
  ...
  $('a[data-toggle="tab"]').on('shown.bs.tab', function () {
    $('.pictureControlsSlider').bootstrapSlider('refresh', {
      useCurrentValue: true
    });
  });
...
window.displayEditFormSubmit = function () {
  ...
  const bandwidthLimitUnitsField = $form.find('select[name=bandwidthLimitUnits]');
  ...
  $form.find('input[type="checkbox"]').each(function (_idx, el) {
    ...
    // Create hidden input
    $('<input type="hidden" class="temp-input">').attr('id', id).attr('name', id).val(value).appendTo($(el).parent());
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data != null) {
        ...
        $('.modal-body').append(templates.display.statusWindow({
          ...statusWindowData,
          ...{
...
/******/ })()
;
//# sourceMappingURL=display-page.bundle.min.js.map