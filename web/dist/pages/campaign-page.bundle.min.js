...
/*!************************************************!*\
  !*** ./ui/src/pages/campaign/campaing-page.js ***!
  \************************************************/
let table;
...
$(document).ready(function () {
  ...
  table.on('draw', {
    form: $('#campaigns').closest('.XiboGrid').find('.FilterDiv form')
...
window.campaignAssignLayoutsFormOpen = function (dialog) {
  ...
  const layoutTable = $layoutAssignments.DataTable({
    ...
    ajax: {
      ...
      data: function (d) {
        $.extend(d, $layoutAssignments.closest('.XiboGrid').find('.layoutAssignFilterOptions').find('input, select').serializeObject());
      }
    },
    columns: [{
      data: 'layoutId'
...
/******/ })()
;
//# sourceMappingURL=campaign-page.bundle.min.js.map