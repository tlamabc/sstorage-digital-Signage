...
$(function () {
  ...
  $('#showAll, #eventTypeId, #recurring, #geoAware,' + ' #DisplayList, #DisplayGroupList,' + ' #name, #useRegexForName, #logicalOperatorName', dialog).on('change', function () {
    setTimeout(calendar.view(), 1000);
  });
    ...
    columns: [{
      ...
      data: function (data) {
        if (data.displayGroups.length > 1 && data.eventTypeId !== 9) {
          return '<span class="badge" ' + 'style="background-color: green; color: white" ' + 'data-toggle="popover" data-trigger="click" ' + 'data-placement="top" data-content="' + data.displayGroupList + '">' + data.displayGroups.length + '</span>';
        } else {
      ...
      data: function (data) {
        if (data.recurringEvent) {
          if (data.recurrenceType === 'Week' && data.recurrenceRepeatsOn) {
            const daysOfTheWeek = [schedulePageTrans.daysOfTheWeek.monday, schedulePageTrans.daysOfTheWeek.tuesday, schedulePageTrans.daysOfTheWeek.wednesday, schedulePageTrans.daysOfTheWeek.thursday, schedulePageTrans.daysOfTheWeek.friday, schedulePageTrans.daysOfTheWeek.saturday, schedulePageTrans.daysOfTheWeek.sunday];
...
/******/ })()
;
//# sourceMappingURL=schedule-page.bundle.min.js.map