...
class __TwigTemplate_773e51e58d5249bdb5a761aeea51c095 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 34
        echo __("Save");
        yield ", \$(\"#playlistSelectFolderForm\").submit()
";
        return; yield '';
    }
    ...
    public function block_formHtml($context, array $blocks = [])
    {
        ...
        // line 40
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Slim\Views\TwigRuntimeExtension')->urlFor("playlist.selectfolder", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["playlist"] ?? null), "playlistId", [], "any", false, false, false, 40)]), "html", null, true);
        yield "\">
        ...
        yield "</label>
                ...
                ";
        // line 55
        yield CoreExtension::callMacro($macros["forms"], "macro_hidden", ["folderId", CoreExtension::getAttribute($this->env, $this->source, ($context["playlist"] ?? null), "folderId", [], "any", false, false, false, 55)], 55, $context, $this->getSourceContext());
        yield "
            </form>
        </div>
    </div>
";
    ...
    {
        return new Source("", "playlist-form-selectfolder.twig", "/var/www/cms/views/playlist-form-selectfolder.twig");
    }
}
