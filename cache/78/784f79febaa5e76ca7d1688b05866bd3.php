...
class __TwigTemplate_514f4b2c87fdab9603a127ba12d343d7 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 25
        $macros["forms"] = $this->macros["forms"] = $this->loadTemplate("forms.twig", "layout-form-checkout.twig", 25)->unwrap();
        // line 24
        $this->parent = $this->loadTemplate("form-base.twig", "layout-form-checkout.twig", 24);
    ...
    ";
        // line 34
        echo __("Checkout");
        yield ", \$(\"#layoutCheckoutForm\").submit()
";
        return; yield '';
    }
    ...
    public function block_formHtml($context, array $blocks = [])
    {
        ...
        // line 40
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Slim\Views\TwigRuntimeExtension')->urlFor("layout.checkout", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["layout"] ?? null), "layoutId", [], "any", false, false, false, 40)]), "html", null, true);
        yield "\">
                ";
        // line 41
...
";
    ...
    {
        return new Source("", "layout-form-checkout.twig", "/var/www/cms/views/layout-form-checkout.twig");
    }
}
