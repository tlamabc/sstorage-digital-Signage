...
var StyledElement = /*#__PURE__*/function (_super) {
  ...
  __proto.render = function () {
    ...
    if ((croact.version || "").indexOf("simple") > -1 && portalContainer) {
      portalAttributes = {
        portalContainer: portalContainer
      };
    }
    return croact.createElement(Tag, __assign(__assign({
...
function styled(Tag, css) {
  ...
  return croact.forwardRef(function (props, ref) {
    var _a = props.className,
      className = _a === void 0 ? "" : _a,
      cspNonce = props.cspNonce,
      attributes = __rest(props, ["className", "cspNonce"]);
    var targetRef = croact.useRef();
    croact.useImperativeHandle(ref, function () {
      return targetRef.current;
    }, []);
    croact.useEffect(function () {
    ...
    return croact.createElement(Tag, __assign({
      "ref": targetRef,
      "data-styled-id": cssId,
      "className": "".concat(className, " ").concat(cssId)
    }, attributes));
