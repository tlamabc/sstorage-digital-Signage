...
class DateParser extends Base
{
    ...
    public function getValidDate($format, $value)
    {
        ...
        if ($date !== false) {
            ...
            // Before PHP 8.2.0, this function did not return false when there were no warnings or errors.
            // Instead, it would always return the documented array structure.
