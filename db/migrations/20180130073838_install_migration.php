...
class InstallMigration extends AbstractMigration
{
    ...
    private function addStructure()
    {
        ...
        $pages
            ...
            ->insert([
                ['pageId' => 1, 'name' => 'dashboard', 'title' => 'Digital Signage', 'asHome' => 1],
...
(33, \'\', \'\', \'text\', \'The fully qualified path to the CMS library location.\', NULL, \'configuration\', 1, \'Library Location\', \'required\', 10, \'\', 1, \'string\'),
(34, \'SERVER_KEY\', \'\', \'text\', NULL, NULL, \'configuration\', 1, \'CMS Secret Key\', \'required\', 20, \'\', 1, \'string\'),
(35, \'HELP_BASE\', \'https://sstorage.vn/\', \'text\', NULL, NULL, \'general\', 1, \'Location of the Manual\', \'required\', 10, \'https://xibosignage.com/manual/\', 1, \'string\'),
...
(61, \'DEFAULT_LANGUAGE\', \'vi_VN\', \'text\', \'The default language to use\', NULL, \'regional\', 1, \'Default Language\', \'\', 10, \'vi_VN\', 1, \'string\'),
